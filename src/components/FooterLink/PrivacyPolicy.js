...
const PrivacyPolicy = () => (
  <div>
    ...
    <div className="privacy-policy-container">
      ...
      <p>
        YesMillennial ("us", "we", or "our") operates the
        http://www.yesmillennial.com website (the "Service").
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for YesMillennial is
        managed through{' '}
      ...
      <p>
        ...
        our Terms and Conditions, accessible from http://www.yesmillennial.com
      </p>
      ...
      <p>YesMillennial uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        YesMillennial will take all steps reasonably necessary to ensure that
      ...
      <p>
        YesMillennial may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of YesMillennial</li>
        <li>
      ...
      <ul>
        <li>By email: nataliesalemme@gmail.com</li>
      </ul>
    </div>
    <Footer />
  </div>
