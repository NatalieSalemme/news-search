...
const TermsOfService = props => (
  <div>
    ...
    <div className="terms-container">
      <h2>Welcome to YesMillennial.com</h2>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of YesMillennial.com's Website.
      </p>{' '}
      <br />
      <span> YesMillennial.com</span> is located at:
      <br />
      <address>
        http://www.yesmillennial.com <br /> <br />
      </address>
      <p>
        By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use YesMillennial.com's website
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using YesMillennial.com's website you
        consent to the use of cookies in accordance with YesMillennial.com’s
        privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, YesMillennial.com and/or it’s licensors own the
        intellectual property rights for all material on YesMillennial.com. All
        intellectual property rights are reserved. You may view and/or print
        pages from http://yesmillennial.com for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from http://yesmillennial.com</li>
        <li>
          Sell, rent or sub-license material from http://yesmillennial.com
        </li>
        <li>
          Reproduce, duplicate or copy material from http://yesmillennial.com
        </li>
      </ol>
      <p>
        Redistribute content from YesMillennial.com (unless content is
      ...
      <p>
        ...
        YesMillennial; and (d) where the link is in the context of general
      ...
      <p>
        ...
        e-mail to{' '}
        <a
          href="mailto:nataliesalemme@gmail.com"
          title="send an email to nataliesalemme@gmail.com"
        >
      ...
      <p>
        No use of YesMillennial.com’s logo or other artwork will be allowed for
